...
public class PollutionBlocksInit {
    public static final Block_Magic_Circle BLOCK_MAGIC_CIRCLE = new Block_Magic_Circle();
    public static final  Item ITEM_BLOCK_MAGIC_CIRCLE =  new ItemBlock(BLOCK_MAGIC_CIRCLE).setRegistryName("pollution",BLOCK_MAGIC_CIRCLE.getRegistryName().getPath());
    @SubscribeEvent
    public static void registerBlock(RegistryEvent.Register<Block> event) {
        ...
        //注册tile entity
        GameRegistry.registerTileEntity(TileEntityMagicCircle.class, new ResourceLocation("pollution", "magic_circle"));
    }
